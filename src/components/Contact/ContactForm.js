...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      />
      and I want to discuss publishing an article here. You can email me at
      ...
      <input
        ...
        focus:border-gray bg-transparent"
      />
      . Here are some details about my article (keep it brief): <br />
      <textarea {...register("article details", {})} 
      placeholder="My article is about..."
      rows={3}
